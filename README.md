...
#### 5. Annealing_wrapped_quicker_code.py is the simulated annealing objective function finder which uses 'model.slim_optimize()' hence the 'quicker
#### 6. Annealing_wrapped_slower_code.py is the simulated annealing objective function finder which uses 'model.optimize()' hence the 'quicker
